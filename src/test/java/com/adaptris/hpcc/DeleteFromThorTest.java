...
public class DeleteFromThorTest extends ProducerCase {

  public DeleteFromThorTest(String name) {
    super(name);
  }
  ...
  protected StandaloneRequestor retrieveObjectForSampleConfig() {
    ...
    p.setDestination(new ConfiguredProduceDestination("~test::file::to::delete"));
